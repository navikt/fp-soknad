...
public record FellesUttaksplanDto(LocalDate termindato,
    ...
    public record Gradering(@Valid @NotNull Arbeidstidprosent arbeidstidprosent, @Valid Aktivitet aktivitet) {
    }

    public record Arbeidstidprosent(@JsonValue BigDecimal value) {
    }

    public record Aktivitet(@NotNull AktivitetType type, @Valid Arbeidsgiver arbeidsgiver, String arbeidsgiverNavn) {
    ...
    public record EøsUttakDto(@NotNull KontoType kontoType, @Valid @NotNull Trekkdager trekkdager) {
