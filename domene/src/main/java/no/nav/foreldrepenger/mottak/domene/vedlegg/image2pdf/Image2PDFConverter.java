package no.nav.foreldrepenger.mottak.domene.vedlegg.image2pdf;
...
import no.nav.foreldrepenger.mottak.domene.vedlegg.error.AttachmentConversionException;
import no.nav.foreldrepenger.mottak.domene.vedlegg.error.AttachmentTypeUnsupportedException;

import org.apache.pdfbox.pdmodel.PDDocument;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import static no.nav.foreldrepenger.mottak.domene.vedlegg.image2pdf.ImageScaler.pdfFraBilde;
import static no.nav.foreldrepenger.mottak.domene.vedlegg.sjekkere.StøttetFormatSjekker.APPLICATION_PDF;
import static no.nav.foreldrepenger.mottak.domene.vedlegg.sjekkere.StøttetFormatSjekker.IMAGE_JPEG;
import static no.nav.foreldrepenger.mottak.domene.vedlegg.sjekkere.StøttetFormatSjekker.IMAGE_PNG;
