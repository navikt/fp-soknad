...
class BehandleEttersendelseTaskTest {
    ...
    void ettersendelse_av_vedlegg_test() {
        ...
        when(arkivtjeneste.forsøkEndeligJournalføring(any(), any(), any(), any())).thenReturn(new OpprettetJournalpost("9999999", true));
        ...
        verify(arkivtjeneste, times(1)).forsøkEndeligJournalføring(any(), eq(dokumenter), any(), any());
