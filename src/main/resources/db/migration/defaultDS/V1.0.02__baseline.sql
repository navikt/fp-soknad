...
CREATE UNIQUE INDEX IDX_DOKUMENT ON FORSENDELSE (FORSENDELSE_ID);
ALTER TABLE FORSENDELSE ADD CONSTRAINT PK_FORSENDELSE UNIQUE (FORSENDELSE_ID);
...
COMMENT ON COLUMN FORSENDELSE.BRUKER_ID IS 'ID til avsenderen av et dokument';
