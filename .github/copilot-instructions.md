...
- Citizen-facing using TokenX. Authorization per endpoint using TilgangskontrollTjeneste. 
...
- `MellomlagringRest`: endpoints to store applications-draft and attachments
- `SøknadRest`: endpoint for each of FP/ES/SVP applications, FP-uttak-change application, and additional documents.
- `SøknadRest.status`: processing status used for frontend polling and routing.
